...
# orch-cli - Orchestration Context
...
**Purpose:** CLI tools for AI agent orchestration - spawn, monitor, complete agents
...
<!-- ORCH-TEMPLATE: core-responsibilities -->
<!-- /ORCH-TEMPLATE -->

<!-- ORCH-TEMPLATE: delegation-thresholds -->
<!-- /ORCH-TEMPLATE -->

<!-- ORCH-TEMPLATE: orchestrator-vs-worker-boundaries -->
<!-- /ORCH-TEMPLATE -->

<!-- ORCH-TEMPLATE: orch-commands -->
<!-- /ORCH-TEMPLATE -->

<!-- ORCH-TEMPLATE: spawning-checklist -->
<!-- /ORCH-TEMPLATE -->

<!-- ORCH-TEMPLATE: verification-checklist -->
<!-- /ORCH-TEMPLATE -->

<!-- ORCH-TEMPLATE: error-recovery-patterns -->
<!-- /ORCH-TEMPLATE -->
